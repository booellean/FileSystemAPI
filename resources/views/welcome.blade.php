...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div>
            ...
            <div class="field">
                <label>Node Id</label>
                <input type="text" name="nodeid" value="8"/>
            </div>
            <div class="field">
            ...
            <script >
                let token = '';
                let button = document.querySelector("button#authbutton");

                function getId() {
                    return document.querySelector('[name="nodeid"]').value;
                }

                function getName() {
                    return document.querySelector('[name="nodename"]').value;
                }
                ...
                function readNode(type) {
                    ...
                    window.axios.get(`/api/node/read/${type}/${id}`, {
                        headers: { Authorization: `Bearer ${token}` }
                    })
                        .then( (res) => {
                            console.log(res);
                ...
                function deleteNode(type) {
                    ...
                    window.axios.get(`/api/node/delete/${type}/${id}`, {
                        headers: { Authorization: `Bearer ${token}` }
                    })
                        .then( (res) => {
                            console.log(res);
